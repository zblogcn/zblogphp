...
,
"CREATE TABLE %pre%Article (log_ID integer primary key auto_increment,log_CateID integer default 0,log_AuthorID integer default 0,log_Level integer default 0,log_Url varchar(255) default '',log_Title varchar(255) default '',log_integerro text default '',log_Content text default '',log_IP varchar(15) default '',log_PostTime timestamp default now(),log_CommNums integer default 0,log_ViewNums integer default 0,log_TrackBackNums integer default 0,log_Tag varchar(255) default '',log_IsTop bit default 0,log_Yea integer default 0,log_Nay integer default 0,log_Ratting integer default 0,log_Template varchar(50) default '',log_FullUrl varchar(255) default '',log_Type integer default 0,log_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
...
,
"CREATE TABLE %pre%Comment (comm_ID integer primary key auto_increment,log_ID integer default 0,comm_AuthorID integer default 0,comm_Author varchar(20) default '',comm_Content text default '',comm_Email varchar(50) default '',comm_HomePage varchar(255) default '',comm_PostTime timestamp default now(),comm_IP varchar(15) default '',comm_Agent text default '',comm_Reply text default '',comm_LastReplyIP varchar(15) default '',comm_LastReplyTime timestamp default now(),comm_Yea integer default 0,comm_Nay integer default 0,comm_Ratting integer default 0,comm_ParentID integer default 0,comm_IsCheck bit default 0,comm_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
...
,
"CREATE TABLE %pre%UpLoad (ul_ID integer primary key auto_increment,ul_AuthorID integer default 0,ul_FileSize integer default 0,ul_FileName varchar(255) default '',ul_PostTime timestamp default now(),ul_Quote varchar(255) default '',ul_DownNum integer default 0,ul_Fileintegerro varchar(255) default '',ul_DirByTime bit default 0,ul_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
