...
class App
{
     ...
     */
    public $ignore_files = ['.gitignore', '.DS_Store', 'Thumbs.db', 'composer.lock', 'zbignore.txt', '*.code-workspace'];
    ...
    public function GetLogo()
    {
        ...
        if (is_readable($this->GetDir() . 'logo.png')) {
            return $this->GetUrl() . 'logo.png';
        }
