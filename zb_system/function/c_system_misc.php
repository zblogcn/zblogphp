...
echo '<div class="center"><div><h1>Z-BlogPHP</h1></div>';
...
$ca = $ca['user'];
echo '<table class="table_striped table_hover"><tbody><tr class="h"><th colspan="2">User Constants</th></tr>';
foreach ($ca as $key => $value) {
...
foreach ($GLOBALS as $n => $v) {
    if(strpos($n,'Filter_Plugin_')===false)$ca['$'.$n] = gettype($v);
}
