...
<?php if($zbp->option['ZC_ADMIN_HTML5_ENABLE']){?><header class="header"><?php }else{?><div class="header"><?php }?>
    <div class="logo"><a href="http://www.rainbowsoft.org/" title="<?php echo $option['ZC_BLOG_PRODUCT'];?>" target="_blank"><img src="<?php echo $bloghost?>zb_system/image/admin/none.gif" alt="Z-Blog"/></a></div>
