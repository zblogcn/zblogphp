...
<header class="header">
    ...
    <div class="user"> <a href="<?php echo $bloghost; ?>zb_system/cmd.php?act=MemberEdt&amp;id=<?php echo $zbp->user->ID; ?>" title="<?php echo $lang['msg']['edit']; ?>"><img src="<?php echo $zbp->user->Avatar; ?>" width="40" height="40" id="avatar" alt="Avatar" /></a>
      ...
      <div class="userbtn"><a class="profile" href="<?php echo $bloghost; ?>" title="" target="_blank"><i class="icon-globe2"></i> <?php echo $lang['msg']['return_to_site']; ?></a>&nbsp;&nbsp;<a class="logout" href="<?php echo BuildSafeCmdURL('act=logout'); ?>" title=""><i class="icon-power"></i> <?php echo $lang['msg']['logout']; ?></a></div>
    </div>
    <div class="menu">
