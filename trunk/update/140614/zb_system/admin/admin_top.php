...
<?php if($zbp->option['ZC_ADMIN_HTML5_ENABLE']){?><header class="header"><?php }else{?><div class="header"><?php }?>
    <div class="logo"><a href="<?php echo $bloghost?>" title="<?php echo TransferHTML($option['ZC_BLOG_NAME'],'[html-format]');?>" target="_blank"><img src="<?php echo $bloghost?>zb_system/image/admin/none.gif" alt="Z-Blog"/></a></div>
