...
?>
  ...
  <form name="form_action" action="action.php" method="post" onsubmit="return test_action();">
    ...
    <nobr>
    <input type="button" class="button" onclick="show_phpinfo()" value="服务器信息">
    <input type="button" class="button" onclick="create_file()" value="新建文件">
    <input type="button" class="button" onclick="create_dir()" value="新建文件夹">
    <input type="button" class="button" onclick="upload_file()" value="上传文件">
...
?>
    ...
    <nobr>
    <input type="button" style="width:80px" class="button" onclick="selectANI(this)" value="全选">
    <input type="button" style="width:80px" class="button" onclick="selectANI(this)" value="反选">
    <input type="button" style="width:80px" class="button" onclick="del()" value="删除">
    <input type="button" style="width:80px" class="button" onclick="copy()" value="复制">
    <input type="button" style="width:80px" class="button" onclick="copy()" value="移动">
    <input type="button" style="width:80px" class="button" onclick="tar()" value="打包">
    <input type="button" style="width:80px" class="button" onclick="chmod()" value="权限">
    </nobr> <br>
    <br>
    <br>
  </form>
