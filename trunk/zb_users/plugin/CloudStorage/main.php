...
<div class="tab-content default-tab" style="border:none;padding:0px;margin:0;" id="tab1">
	<table style="padding:0px;margin:0px;width:100%;">
		...
		<tr><td><p><b>存储根目录</b></p></td><td><p><input id="CS_Dir" name="CS_Dir" style="width:600px;"  type="text" value="<?php echo $zbp->Config('CloudStorage')->CS_Dir;?>" /></p>前面不需要加“/”,后面需要加“/”</td></tr>
	</table>
</div>
<div class="tab-content" style="border:none;padding:0px;margin:0;" id="tab2">
	<table style="padding:0px;margin:0px;width:100%;">
		<tr><td><p><b>Access Key ID</b></p></td><td><p><input id="CS_Ali_KeyID" name="CS_Ali_KeyID" style="width:600px;" type="text" value="<?php echo $zbp->Config('CloudStorage')->CS_Ali_KeyID;?>" /></p>http://i.aliyun.com/access_key/</td></tr>
...
<div class="tab-content" style="border:none;padding:0px;margin:0;" id="tab3">
	<table style="padding:0px;margin:0px;width:100%;">
		<tr><td><p><b>AccessKey</b></p></td><td><p><input id="CS_QNiu_KeyID" name="CS_QNiu_KeyID" style="width:600px;" type="text" value="<?php echo $zbp->Config('CloudStorage')->CS_QNiu_KeyID;?>" /></p>https://portal.qiniu.com/setting/key</td></tr>
...
<div class="tab-content" style="border:none;padding:0px;margin:0;" id="tab4">
	<table style="padding:0px;margin:0px;width:100%;">
		<tr><td><p><b>Access Key</b></p></td><td><p><input id="CS_Baidu_KeyID" name="CS_Baidu_KeyID" style="width:600px;" type="text" value="<?php echo $zbp->Config('CloudStorage')->CS_Baidu_KeyID;?>" /></p>http://developer.baidu.com/bae/ref/key/</td></tr>
