...
TaskTap = (function(){
	var _bindTab = function(){
		$('.task_tab .tab').live('mouseenter',function (e) {
			if (!$(this).hasClass('this')){
				$(this).addClass('hover');
			}
		}).unbind('click').live('click',function(){
			var id = $(this).attr('id');
			if (id == dialog_focus_id){
	...
	var _bindDrag = function(){
		...
		$('.task_tab .tab').unbind('mousedown').live('mousedown',function(e){
			$self = $(this);
			isDraging = true;
	...
	var _add = function(id,title){
		$('.task_tab').css('display','block');
		var html_tab = '<div class="tab" id="'+id+'">'+title+'</div>';
...
$(document).ready(function() {
	var html = 
	'<div class="task_tab" style="display:none;"><div class="tabs">'+
