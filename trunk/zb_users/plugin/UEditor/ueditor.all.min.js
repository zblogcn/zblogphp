...
if(h.collapsed){var g=this.document.createTextNode("d");h.insertNode(g)}d(h,this,b);g&&(h.setStartBefore(g).collapse(!0),e.remove(g));h.select();return!0},queryCommandValue:function(){var c=a(this);return c?c.getAttribute("dir"):"ltr"}}})();UE.plugins.horizontal=function(){this.commands.horizontal={execCommand:function(e){if(-1!==this.queryCommandState(e)){0!=this.document.getElementsByTagName("hr").length?this.execCommand("insertHtml","<hr>"):this.execCommand("insertHtml",'<hr class="more"/>');e=this.selection.getRange();var a=e.startContainer;if(1==a.nodeType&&!a.childNodes[e.startOffset]){var d;
