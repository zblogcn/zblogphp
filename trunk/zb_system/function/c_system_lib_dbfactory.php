...
,
"CREATE TABLE %pre%Article (log_ID integer primary key autoincrement,log_CateID integer default 0,log_AuthorID integer default 0,log_Level integer default 0,log_Alias varchar(255) default '',log_Title varchar(255) default '',log_Intro text default '',log_Content text default '',log_IP varchar(20) default '',log_PostTime timestamp default (datetime('now', 'localtime')),log_CommNums integer default 0,log_ViewNums integer default 0,log_TrackBackNums integer default 0,log_Tag varchar(255) default '',log_IsTop bit default 0,log_Yea integer default 0,log_Nay integer default 0,log_Ratting integer default 0,log_Template varchar(50) default '',log_Url varchar(255) default '',log_Type integer default 0,log_Meta text default '')"
,
...
,
"CREATE TABLE %pre%Member (mem_ID integer primary key autoincrement,mem_Guid  varchar(36) default '',mem_Level integer default 0,mem_Name varchar(20) default '',mem_Password varchar(32) default '',mem_Sex integer default 0,mem_Email varchar(50) default '',mem_HomePage varchar(255) default '',mem_LastVisit timestamp default (datetime('now', 'localtime')),mem_Status integer default 0,mem_Articles integer default 0,mem_Pages integer default 0,mem_Comments integer default 0,mem_Intro text default '',mem_IP varchar(20) default '',mem_Count integer default 0,mem_Template varchar(50) default '',mem_Url varchar(255) default '',mem_Alias varchar(255) default '',mem_Meta text default '')"
,
...
,
"CREATE TABLE %pre%Article (log_ID integer primary key,log_CateID integer default 0,log_AuthorID integer default 0,log_Level integer default 0,log_Alias varchar(255) default '',log_Title varchar(255) default '',log_Intro text default '',log_Content text default '',log_IP varchar(20) default '',log_PostTime timestamp default current_timestamp,log_CommNums integer default 0,log_ViewNums integer default 0,log_TrackBackNums integer default 0,log_Tag varchar(255) default '',log_IsTop bit default 0,log_Yea integer default 0,log_Nay integer default 0,log_Ratting integer default 0,log_Template varchar(50) default '',log_Url varchar(255) default '',log_Type integer default 0,log_Meta text default '')"
,
...
,
"CREATE TABLE %pre%Member (mem_ID integer primary key,mem_Level integer default 0,mem_Guid  varchar(36) default '',mem_Name varchar(20) default '',mem_Password varchar(32) default '',mem_Sex integer default 0,mem_Email varchar(50) default '',mem_MSN varchar(50) default '',mem_QQ varchar(50) default '',mem_HomePage varchar(255) default '',mem_LastVisit timestamp default current_timestamp,mem_Status integer default 0,mem_Articles integer default 0,mem_Pages integer default 0,mem_Comments integer default 0,mem_Intro text default '',mem_IP varchar(20) default '',mem_Count integer default 0,mem_Template varchar(50) default '',mem_Url varchar(255) default '',mem_Alias varchar(255) default '',mem_Meta text default '')"
,
"CREATE TABLE %pre%Config (conf_Name varchar(255) not null default '',conf_Value text default '')"
,
