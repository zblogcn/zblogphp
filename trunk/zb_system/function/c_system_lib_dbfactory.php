...
,
"CREATE TABLE %pre%Article (log_ID integer primary key auto_increment,log_CateID integer default 0,log_AuthorID integer default 0,log_Level integer default 0,log_Url varchar(255) default '',log_Title varchar(255) default '',log_integerro text default '',log_Content text default '',log_IP varchar(20) default '',log_PostTime timestamp default CURRENT_timestamp,log_CommNums integer default 0,log_ViewNums integer default 0,log_TrackBackNums integer default 0,log_Tag varchar(255) default '',log_IsTop bit default 0,log_Yea integer default 0,log_Nay integer default 0,log_Ratting integer default 0,log_Template varchar(50) default '',log_FullUrl varchar(255) default '',log_Type integer default 0,log_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
"CREATE TABLE %pre%Category (cate_ID integer primary key auto_increment,cate_Name varchar(50) default '',cate_Order integer default 0,cate_integerro text default '',cate_Count integer default 0,cate_URL varchar(255) default '',cate_ParentID integer default 0,cate_Template varchar(50) default '',cate_LogTemplate varchar(50) default '',cate_FullUrl varchar(255) default '',cate_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
...
,
"CREATE TABLE %pre%TrackBack (tb_ID integer primary key auto_increment,log_ID integer default 0,tb_URL varchar(255) default '',tb_Title varchar(100) default '',tb_Blog varchar(50) default '',tb_Excerpt text default '',tb_PostTime timestamp default CURRENT_timestamp,tb_IP varchar(20) default '',tb_Agent text default '',tb_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
"CREATE TABLE %pre%UpLoad (ul_ID integer primary key auto_increment,ul_AuthorID integer default 0,ul_FileSize integer default 0,ul_FileName varchar(255) default '',ul_PostTime timestamp default CURRENT_timestamp,ul_Quote varchar(255) default '',ul_DownNum integer default 0,ul_Fileintegerro varchar(255) default '',ul_DirByTime bit default 0,ul_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
...
,
"CREATE TABLE %pre%Keyword (key_ID integer primary key auto_increment,key_Name varchar(255) default '',key_integerro text default '',key_URL varchar(255) default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
"CREATE TABLE %pre%Member (mem_ID integer primary key auto_increment,mem_Level integer default 0,mem_Name varchar(20) default '',mem_Password varchar(32) default '',mem_Sex integer default 0,mem_Email varchar(50) default '',mem_MSN varchar(50) default '',mem_QQ varchar(50) default '',mem_HomePage varchar(255) default '',mem_LastVisit timestamp default CURRENT_timestamp,mem_Status integer default 0,mem_PostLogs integer default 0,mem_PostComms integer default 0,mem_integerro text default '',mem_IP varchar(20) default '',mem_Count integer default 0,mem_Template varchar(50) default '',mem_FullUrl varchar(255) default '',mem_Url varchar(255) default '',mem_Guid  varchar(36) default '',mem_Meta text default '') ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci"
,
...
,
"CREATE TABLE %pre%Member (mem_ID integer primary key autoincrement,mem_Level integer default 0,mem_Name varchar(20) default '',mem_Password varchar(32) default '',mem_Sex integer default 0,mem_Email varchar(50) default '',mem_MSN varchar(50) default '',mem_QQ varchar(50) default '',mem_HomePage varchar(255) default '',mem_LastVisit timestamp default (datetime('now', 'localtime')),mem_Status integer default 0,mem_PostLogs integer default 0,mem_PostComms integer default 0,mem_integerro text default '',mem_IP varchar(20) default '',mem_Count integer default 0,mem_Template varchar(50) default '',mem_FullUrl varchar(255) default '',mem_Url varchar(255) default '',mem_Guid  varchar(36) default '',mem_Meta text default '')"
,
...
,
"CREATE TABLE %pre%TrackBack (tb_ID integer primary key,log_ID integer default 0,tb_URL varchar(255) default '',tb_Title varchar(100) default '',tb_Blog varchar(50) default '',tb_Excerpt text default '',tb_PostTime timestamp default current_timestamp,tb_IP varchar(20) default '',tb_Agent text default '',tb_Meta text default '')"
,
