...
<#template:article_commentpost-verify:begin#>
	<p><input type="text" name="inpVerify" id="inpVerify" class="text" value="" size="28" tabindex="4" /> <label for="inpVerify"><#msg089#>(*)</label> <img style="border:1px solid silver;width:<#ZC_VERIFYCODE_WIDTH#>px;height:<#ZC_VERIFYCODE_HEIGHT#>px;" src="{#ZC_BLOG_HOST#}zb_system/function/c_validcode.php?name=commentvalid" alt="" title=""/></p>
