...
<dl>
	<form method="post" class="setting">
        ...
        <dd class="half<?php if($zbp->Config('tpure')->PostFILTERCATEGORY != '0'){echo " hide";}?>">
            ...
            <input type="text" id="PostFILTERCATEGORYID"<?php if($zbp->Config('tpure')->PostFILTERCATEGORY == '0'){echo ' name="PostFILTERCATEGORY"';}?> value="<?php echo $zbp->Config('tpure')->PostFILTERCATEGORY;?>" placeholder="不过滤请留空" class="PostFILTERCATEGORY settext" />
		...
		<dd class="ajaxinfo"<?php echo $zbp->Config('tpure')->PostAJAXON == 1?'':' style="display:none"';?>>
