            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                        <?php
                        if ($zbp->Config('tpure')->PostLOGO) {
                            ?>
                            <img src="<?php echo $zbp->Config('tpure')->PostLOGO; ?>" alt="" width="120" class="thumbimg">
                            <?php
                        } else {
                            ?>
                            <img src="style/images/logo.png" alt="" width="120" class="thumbimg">
                            <?php
                        }
                        ?>
                        </td>
                        <td><input type="text" id="PostLOGO" name="PostLOGO" value="
                        <?php
                        if ($zbp->Config('tpure')->PostLOGO) {
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                        <?php
                        if ($zbp->Config('tpure')->PostFAVICON) {
                            ?>
                            <img src="<?php echo $zbp->Config('tpure')->PostFAVICON; ?>" alt="" width="16" class="thumbimg">
                            <?php
                        } else {
                            ?>
                            <img src="style/images/favicon.ico" alt="" width="16" class="thumbimg">
                            <?php
                        }
                        ?>
                        </td>
                        <td><input type="text" id="PostFAVICON" name="PostFAVICON" value="
                        <?php
                        if ($zbp->Config('tpure')->PostFAVICON) {
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                        <?php
                        if ($zbp->Config('tpure')->PostTHUMB) {
                            ?>
                            <img src="<?php echo $zbp->Config('tpure')->PostTHUMB; ?>" alt="" width="120" class="thumbimg">
                            <?php
                        } else {
                            ?>
                            <img src="style/images/thumb.png" alt="" width="120" class="thumbimg">
                            <?php
                        }
                        ?>
                        </td>
                        <td><input type="text" id="PostTHUMB" name="PostTHUMB" value="
                        <?php
                        if ($zbp->Config('tpure')->PostTHUMB) {
