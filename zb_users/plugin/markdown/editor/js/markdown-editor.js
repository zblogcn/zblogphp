        ...
        fullscreen: function(delegate) {
            if ( ! delegate.is_full_screen) {
                ...
                var s = '<div data-backdrop="false" class="modal hide" style="z-index:1040;top:0;left:0;margin-left:0;-webkit-border-radius:0;-moz-border-radius:0;border-radius:0;">'
                      + '<div class="left" style="margin:0;padding:0 2px 2px 2px;float:left;"></div><div class="right" style="float:right;padding:0;margin:0;border-left:solid 1px #ccc;overflow:scroll;"></div>'
                      + '</div>';
                $('body').prepend(s);
                var $modal = $('body').children(':first');
                ...
                delegate.$textarea.css('width', '100%').css('height', delegate.$textarea_old_height);
            }
        },
