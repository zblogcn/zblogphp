...
<p>使用说明：</p>
	  <p>
将 <b style="font-size:1.5em;">{$article.HeartComment()}</b> 标签放入你当前主题的<b>post-single.php<b>模板里的合适的位置，并在后台点[更新缓存]编译模板即可生效。
	  </p>
...
function changeOptions(i){
	...
	<script type="text/javascript">AddHeaderIcon("<?php echo $bloghost . 'zb_users/plugin/HeartComment/logo.png';?>");</script>	
  </div>
</div>
