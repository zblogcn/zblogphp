...
if (isset($_POST['upyun_enable_Thumbnail']) && $_POST['upyun_enable_Thumbnail'] != '') {
	...
	if ($zbp->Config('upyun')->upyun_ver_name == '') {
		$buff = "请设置版本名！！！";
	}
...
<div id="divMain">
  ...
  <tr>
    ...
    <td><p align="left"><input name="upyun_ver_name" type="text" id="upyun_ver_name" size="100%" value="<?php echo $zbp->Config('upyun')->upyun_ver_name;?>" /></p>请在又拍云创建相应的版本名称：https://www.upyun.com/cp/#/buckets/<?php echo $zbp->Config('upyun')->upyun_bucket;?>/thumbs/list/</td>
  </tr>
</table>
 <br />
