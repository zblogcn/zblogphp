                ...
                if (preg_match("/^Filter/i", $key, $matches)) {
                    foreach ($GLOBALS[$key] as $k => $v) {
                        if (function_exists($k)) {
                            echo '<tr><td>' .
                                $key . '</td><td>' .
                                $k . '</td><td class="center">' .
                                get_plugin_name_debugger($k) . '</td><td class="center">
                                <span class="debug-plg-detail" interface="' .
                                $key . '" func="' . $k . '" title="查看/隐藏详情">
                                ⅰ</span></td></tr><tr style="display:none">
                                <td colspan="4"></td></tr>';
                        }
                    }
                }
