...
var zen_settings = {
	'variables': {
		...
		'locale': 'en-US',
		'charset': 'utf-8',		
		'indentation': '\t',/** Inner element indentation */		
	...
	'css': {
		...
		'snippets': {
			...
			//css acp editplus  自动补全代码，覆盖原有zendCoding规则。
			'f':'font:normal normal bold 12px/1.5em "Arial";',
			'ff':'font-family:"|";',
			'fs':'font-size:|px;',
			...
			'bi':'background-image:url("|") no-repeat;',
			'bai':'background-image:url("|") no-repeat;',
			'bau':'background:url("|") no-repeat;',
	...
	'html': {
		...
		'snippets': {
			...
			"mp3":'<embed src="|" width="80" height="20" type="audio/mpeg" loop="true" autostart="true"/>\n',
			"swf":'<embed width="500" height="100" type="application/x-shockwave-flash" src="|.swf"/>\n',
			"flash":'<embed width="500" height="100" type="application/x-shockwave-flash" src="|.swf"/>\n',
			"object":'<object data="" type="" id="|" width="" height="" classid="">\n</object>\n',
			"audio":'<audio controls preload="">\n  <source src="" type="audio/mpeg" />\n</audio>\n',
			"video":'<video width="|" height="" controls preload="" poster="">\n  <source src="" type="video/mp4" />\n</video>\n',
			"map":'<map name="|">\n	<area shape="" href="" coords="" alt="">\n</map>',
			"table":'<table align="center" border=0 cellspacing=0 cellpadding=0>\n\t|\n</table>',
			"clear":'<div style="clear:both"></div>\n',
			"css":'<link rel="stylesheet" type="text/css" href="|">',
			"js":'<script language="JavaScript" src="|"></script>',
			'style': '<style type="text/css">\n\t|\n</style>',
			'script': '<script type="text/javascript">\n\t|\n</script>',	
		},		
		'abbreviations': {
//=======================myself--form about tags &in html5=====================
			"_form":'<form method="post" action="">\n	\t|\n</form>\n',
			"_button":'<input type="button" name="|" value="" class="" />\n',
			"_checkbox":'<input type="checkbox" name="|" value="" class="" />\n',
			"_input":'<input type="|" name="" value="" />\n',
			"_hidden":'<input type="hidden" name="|" value="" />\n',
			"_image":'<input type="image" src="|">\n',
			"_option":'<option value="|"></option>\n',
			"_password":'<input type="password" name="|" class="" />\n',
			"_radio":'<input type="radio" name="|" value="" class="" />\n',
			"_reset":'<input type="reset" name="|" value="" class="" />\n',
			"_text":'<input type="text" name="|" value="" class="" />\n',
			"_textarea":'<textarea name="|" rows="" cols=""></textarea>\n',
			"_submit":'<input type="submit"  value="|" class="" />\n',
			"_reset":'<input type="reset" value="重置" class="|" />',
			"_search":'<input type="search" name="|" value="" class="" />\n',
			"_email":'<input type="email" name="|" value="" class="" />\n',
			"_url":'<input type="url" name="|" value="" class="" />\n',
			"_tel":'<input type="tel" name="|" value="" class="" />\n',
			"_range":'<input type="range" min="" max="" name="|" value="" class="" />\n',
			"_number":'<input type="number" min="" max="" name="|" value="" class="" />\n',
			"_date":'<input type="date" name="|" value="" class="" />\n',
			"_datetime":'<input type="datetime" name="|" value="" class="" />\n',
			"_time":'<input type="time" name="|" value="" class="" />\n',
			"_month":'<input type="month" name="|" value="" class="" />\n',
			"_week":'<input type="week" name="|" value="" class="" />\n',
			"_color":'<input type="color" name="|" value="" class="" />\n',
			"_formimage":'<input type="image" src="|" value="" class="" />',
//=========================myself tags end==========================
			...
			'link:href': '<link rel="stylesheet" type="text/css" href="${1:style}.css" media="all" />',
			...
			'iframe': '<iframe src="|" name="" frameborder="0" width="" height="" scrolling="no">\n',
			'frame': '<iframe src="|" name="" frameborder="0">',			
		...
		'element_types': {
			'empty': 'area,base,basefont,br,col,hr,img,input,isindex,link,meta,param,embed,keygen,command',
			'block_level': 'address,applet,blockquote,button,center,dd,del,dir,div,dl,dt,fieldset,form,hr,iframe,ins,isindex,li,link,map,menu,noframes,noscript,object,ol,p,pre,script,table,tbody,td,tfoot,th,thead,tr,ul,h1,h2,h3,h4,h5,h6',
