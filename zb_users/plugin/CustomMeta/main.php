...
<div id="divMain">
  ...
  <div class="SubMenu">
 <a href="?type=post"><span class="m-left <?php if($_GET['type'] == 'post')echo 'm-now';?>">文章自定义域</span></a>
 <a href="?type=category"><span class="m-left <?php if($_GET['type'] == 'category')echo 'm-now';?>">分类自定义域</span></a>
 <a href="?type=tag"><span class="m-left <?php if($_GET['type'] == 'tag')echo 'm-now';?>">标签自定义域</span></a>
 <a href="?type=member"><span class="m-left <?php if($_GET['type'] == 'member')echo 'm-now';?>">用户自定义域</span></a>
  </div>
  <div id="divMain2">
