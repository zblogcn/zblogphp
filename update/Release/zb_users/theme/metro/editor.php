		...
		<form action="save.php" method="post">
			<table width="100%" border="1" width="100%" class="tableBorder">
				...
				<tr>
					...
					<td >
						<div id="layoutset">
							<input type="radio" id="layoutl" name="layout" value="l" <?php echo $strlayout=='l'?'checked="checked"':''; ?> /><label for="layoutl">侧栏居左</label>
							<input type="radio" id="layoutr" name="layout" value="r" <?php echo $strlayout=='r'?'checked="checked"':''; ?> /><label for="layoutr">侧栏居右</label>
						</div>
					</td>
				</tr>
				<tr>
					<td>顶部背景</td>
					<td>
						<div >顶部高度：<input id="hdbgph" type="text" name="hdbg5"  size="3"  value="<?php echo $aryHdBg[5];?>" />（单位：px）</div>
						<div id="hdbgcolor" >
							<input type="checkbox" id="hdbgc0" name="hdbg0" <?php echo $aryHdBg[0]=='transparent'?'checked="checked"':''; ?> value="transparent"/><label for="hdbgc0"> 背景透明（不透明情况下使用主色为背景色）</label>
						</div>
						<div >
							<input type="checkbox" id="hdbgc6" name="hdbg6" <?php echo $aryHdBg[6]=='True'?'checked="checked"':''; ?> value="True"/> <label for="hdbgc6">使用背景图</label>
						</div>
						<div id="hdbgmain" <?php echo $aryHdBg[6]==""?'style="display:none"':"" ?>>
							...
							<div id="hdbgs">背景设定：
							<input type="checkbox" id="hdbg2r" name="hdbg2[]" <?php echo stripos($aryHdBg[2],"repeat")?"checked='checked'":""; ?> value="repeat"/>
							<label for="hdbg2r">平铺</label>
							<input type="checkbox" id="hdbg2f" name="hdbg2[]" <?php echo stripos($aryHdBg[2],"fixed")?"checked='checked'":""; ?> value="fixed"/>
							<label for="hdbg2f">固定</label>
							</div> 
							<div id="hdbgpx"> 对齐方式： 			  
								<?php	for($i=1 ;$i<= 3;$i++){	 ?>
										<input type="radio" id="hdbgpx<?php echo $i ?>" name="hdbg3" value="<?php echo $i ?>" <?php echo $i==(int)$aryHdBg[3]?"checked='checked'":""; ?> /><label for="hdbgpx<?php echo $i ?>">居<?php echo $a[$i] ?></label>
								<?php	}   ?>
							</div> 
						<input id="hdbgpy" type="hidden" name="hdbg4"  value="<?php echo $aryHdBg[4] ?>" />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div id="bgcolor">
							背景颜色：<input id="bodybgc0" name="bodybg0"  value="<?php echo $aryBodyBg[0] ?>" /> 
						</div>
						<div >
							<input type="checkbox" id="bodybgc5" name="bodybg5" <?php echo $aryBodyBg[5]=='True'?'checked="checked"':''; ?> value="True"/> <label for="bodybgc5">使用背景图</label>
						</div>
						<div id="bodybgmain" <?php echo $aryBodyBg[5]==""?'style="display:none"':""; ?>>
							...
							<div id="bodybgs">背景设定：
							<input type="checkbox" id="bodybg2r" name="bodybg2[]" <?php echo stripos($aryBodyBg[2],"repeat")?"checked='checked'":""; ?> value="repeat"/>
							<label for="bodybg2r">平铺</label>  
							<input type="checkbox" id="bodybg2f" name="bodybg2[]" <?php echo stripos($aryBodyBg[2],"fixed")?"checked='checked'":""; ?> value="fixed"/>
							<label for="bodybg2f">固定</label>
							</div> 
							<div id="bgpx"> 对齐方式： 			  
							<?php	for($i=1 ;$i<= 3;$i++){	 ?>
							<input type="radio" id="bgpx<?php echo $i ?>" name="bodybg3" value="<?php echo $i ?>" <?php echo $i==(int)$aryBodyBg[3]?"checked='checked'":""; ?> /><label for="bgpx<?php echo $i ?>">居<?php echo $a[$i] ?></label>
							<?php	}   ?>
							</div> 
							<input type="hidden" id="bgpy" name="bodybg4"  value="<?php echo $aryBodyBg[4] ?>" />
						</div>
					</td>
				</tr>
			</table>
			...
			<table width="100%" border="1" width="100%" class="tableBorder">
				...
				<tr>
					<td>主色（深色）</td>
					<td><input id="colorP1" name="color[]"  value=<?php echo $aryColor[0] ?> /></td>
				</tr>
				<tr>
					<td>次色（浅色）</td>
					<td><input  id="colorP2" name="color[]"  value=<?php echo $aryColor[1] ?> /></td>
				</tr>
				<tr>
					<td>字体颜色</td>
					<td><input  id="colorP3" name="color[]"  value=<?php echo $aryColor[2] ?> /></td>
				</tr>
				<tr>
					<td>链接颜色</td>
					<td><input  id="colorP4" name="color[]"  value=<?php echo $aryColor[3] ?> /></td>
				</tr>
				<tr>
					<td>文章背景色</td>
					<td><input  id="colorP5" name="color[]"  value=<?php echo $aryColor[4] ?> /></td>
				</tr>
			</table>
